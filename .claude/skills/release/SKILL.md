...
# Releasing cmem-plugin-salesforce
...
Then watch the publish workflow at https://github.com/eccenca/cmem-plugin-salesforce/actions and confirm the
new version appeared on [PyPI](https://pypi.org/project/cmem-plugin-salesforce/).
